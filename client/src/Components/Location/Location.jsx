...
export default function Location() {
  ...
  function printKakaomap() {
    ...
    var options = {
      center: new window.kakao.maps.LatLng(35.86967, 128.5708),
      level: 3,
    };
    ...
    positions.forEach(function (position) {
      ...
      var infowindowContent = ReactDOMServer.renderToString(<LocationModal title={position.title} adress={position.adress} number={position.number} />);
